...
class HashSet {
 ...
 public:
  ...
  const BucketList& GetBucket(const Type& value) const { return v[hasher_(value) % v.size()]; }
  BucketList& GetBucket(const Type& value) { return v[hasher_(value) % v.size()]; }
